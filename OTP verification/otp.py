...
password = "zqjw uwxf udae pfta"
server.login("pallavic0208@gmail.com",password)

body = "dear"+name+","+"\n"+"\n"+"your OTP is "+str(OTP)+"."
subject = "OTP verification using python"
message = f'subject:{subject}\n\n{body}'

server.sendmail("pallavic0208@gmail.com",valid_receiver_email,message)
...
def sending_otp(receiver_email):
    ...
    subject = "OTP verification using python" 
    message = f'subject:{subject}\n\n{body}'
    server.sendmail("pallavic0208@gmail.com",receiver_email,message)
